...
(function(window, $, undefined) {
  ...
  // XXX !Edited Add execution limit
  var arriveEvents = new MutationEvents(getArriveObserverConfig, arriveDefaultOptions, $.throttle(500, onArriveMutation)), 
      leaveEvents  = new MutationEvents(getLeaveObserverConfig, leaveDefaultOptions, $.throttle(500, onLeaveMutation));
